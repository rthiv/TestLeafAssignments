...
public class Assignment4Buttons {
	...
	public static void main(String[] args) {
		...
		System.out.println("Color: " +driver.findElement(By.xpath("//button[@id='j_idt88:j_idt96']")).getCssValue("background-color"));
		...
		System.out.println("Before scroll: " + mouseOver.getCssValue("background-color"));
		Actions mouse = new Actions(driver);
		mouse.moveToElement(mouseOver).perform();
		System.out.println("After scroll: " + mouseOver.getCssValue("background-color"));
